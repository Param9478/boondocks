    ...
    <div>
      <div className="relative">
        <img
          ...
          className="object-cover h-72 w-full brightness-50"
          style={{ objectPosition: 'center 50%' }}
        />
        {/* Text Content */}
        <div className="absolute text-center sm:text-left w-full sm:w-3/4 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white flex sm:flex-row flex-col sm:space-x-14 justify-between ">
          <div className="w-3/5 m-auto">
            <h1 className="lg:text-2xl md:text-lg sm:text-md font-light w-full">
          ...
          <div className="w-full sm:w-1/3 sm:m-auto mt-5">
